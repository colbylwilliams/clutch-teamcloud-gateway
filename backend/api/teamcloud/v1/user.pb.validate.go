...
func (m *User) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetAlternateIdentities()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UserValidationError{
					field:  "AlternateIdentities",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetAlternateIdentities()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return UserValidationError{
				field:  "AlternateIdentities",
				reason: "embedded message failed validation",
	...
	if m.MailAddress != nil {
		// no validation rules for MailAddress
	}
