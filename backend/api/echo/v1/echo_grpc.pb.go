...
func (c *echoAPIClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/colbylwilliams.echo.v1.EchoAPI/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EchoAPI_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/colbylwilliams.echo.v1.EchoAPI/SayHello",
	}
...
var EchoAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "colbylwilliams.echo.v1.EchoAPI",
